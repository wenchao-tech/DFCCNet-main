...
if __name__ == '__main__':
    ...
    ckpt = torch.load(os.path.join('/home/ubuntu/workshop/DFCCNet/experiment/ITS/DFCCNet/saved_model', opt.pre_trained_model), map_location='cpu')
