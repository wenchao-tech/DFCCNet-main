...
parser.add_argument('--model_name', type=str, default='DFCCNet', help='experiment name')
...
opt.val_dataset_dir = os.path.join('/home/ubuntu/workshop/dataset/outdoor/test/') #ITS
